...
package edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems;
...
/**
 * Updated by JCasGen Fri Oct 25 22:25:39 EDT 2013
 * 
 * @generated
 */
public class Document_Type extends Annotation_Type {
  ...
  public final static boolean featOkTst = JCasRegistry
          .getFeatOkTst("edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
    if (featOkTst && casFeat_relevanceValue == null)
      jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems.Document");
  ...
  public int getQueryID(int addr) {
    if (featOkTst && casFeat_queryID == null)
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems.Document");
  ...
  public String getText(int addr) {
    if (featOkTst && casFeat_text == null)
      jcas.throwFeatMissing("text", "edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems.Document");
  ...
  public int getTokenList(int addr) {
    if (featOkTst && casFeat_tokenList == null)
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f13.hw4.hw4_wyuan.typesystems.Document");
  ...
  public Document_Type(JCas jcas, Type casType) {
    ...
    casFeat_relevanceValue = jcas.getRequiredFeatureDE(casType, "relevanceValue",
            "uima.cas.Integer", featOkTst);
    casFeatCode_relevanceValue = (null == casFeat_relevanceValue) ? JCas.INVALID_FEATURE_CODE
    ...
    casFeatCode_queryID = (null == casFeat_queryID) ? JCas.INVALID_FEATURE_CODE
    ...
    casFeat_tokenList = jcas.getRequiredFeatureDE(casType, "tokenList", "uima.cas.FSList",
            featOkTst);
    casFeatCode_tokenList = (null == casFeat_tokenList) ? JCas.INVALID_FEATURE_CODE
